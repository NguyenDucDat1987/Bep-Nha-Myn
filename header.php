...
elseif (file_exists(__DIR__ . '/auth_functions.php'))
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <?php else: ?>
                            ...
                            <div class="d-flex align-items-center me-3">
                                <div class="rounded-circle shadow-sm d-flex align-items-center justify-content-center bg-white"
                                    ...
                                    <svg width="42" height="42" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M16 26C16 18 20 12 32 12C44 12 48 18 48 26C52 26 54 28 54 32C54 35 52 37 48 37L16 37C12 37 10 35 10 32C10 28 12 26 16 26Z"
                                            fill="#ECEFF1" />
                                        <path d="M16 37L48 37L48 42C48 43 47 44 46 44L18 44C17 44 16 43 16 42L16 37Z"
                                            fill="#CFD8DC" />
                                        <path d="M20 44L44 44L44 50C44 56 38 60 32 60C26 60 20 56 20 50L20 44Z"
                                            fill="#FFCCBC" />
                                        <path d="M16 50L24 62L40 62L48 50" fill="#FF7043" />
                                        <path
                                            d="M26 52C26 52 28 50 32 50C36 50 38 52 38 52C38 52 36 54 32 54C28 54 26 52 26 52Z"
                                            fill="#5D4037" />
                                    </svg>
                                ...
                                <div class="ms-2 d-flex flex-column justify-content-center">
                                    <span class="text-white fw-bold"
                                        style="font-size: 1rem; line-height: 1.2; text-shadow: 0 1px 2px rgba(0,0,0,0.1);">
                                        <?= htmlspecialchars($h_currentUser['username']) ?>
                                    </span>
                                    <span class="badge bg-warning text-dark rounded-pill shadow-sm"
                                        style="font-size: 0.65rem; width: fit-content; margin-top: 2px;">
                            ...
                            <?php if ($currentScript === 'index.php'): ?>
                                <a href="manage_dishes.php" class="nav-btn"
                                    style="background: var(--k-white); color: var(--k-primary);">
