...
<div class="modal fade" id="guestPopup" tabindex="-1" aria-labelledby="guestPopupLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 20px; overflow: hidden;">
            <div class="modal-header text-white" style="background: linear-gradient(135deg, var(--k-primary), #E64A19);">
            ...
            <div class="modal-body p-4 text-center">
                ...
                <p class="text-muted text-start">
                    Xuất phát từ việc "nóc nhà" 🏠 của mình ngày nào cũng xoắn não nghĩ món ăn, mình đã tạo ra chiếc web này để phó mặc cho nhân phẩm.
                </p>

                <div class="alert alert-warning border-0 small shadow-sm text-start" style="background-color: #FFF8E1; color: #5D4037;">
                    <i class="fas fa-star text-warning me-1"></i> Để trải nghiệm xịn nhất, bạn hãy <b>Đăng ký / Đăng nhập</b> nhé. Lúc đó bạn sẽ được tự quản lý danh sách món ăn yêu thích của riêng mình thay vì dùng danh sách mặc định.
                </div>
                
                <p class="small text-muted fst-italic mb-4 text-start">
                    * Web vẫn đang hoàn thiện, nếu thấy lỗi gì hãy nhắn mình để mình fix ngay. Cảm ơn bạn đã ghé thăm!
                </p>
                ...
                <div class="text-center mt-3">
                    <button type="button" class="btn btn-link text-muted text-decoration-none btn-sm" data-bs-dismiss="modal" style="font-size: 0.85rem;">
